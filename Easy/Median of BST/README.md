<h2><a href="https://www.geeksforgeeks.org/problems/median-of-bst/1?page=2&company=Amazon,Microsoft,Flipkart,Adobe,Google,Samsung&difficulty=Easy,Medium,Hard&status=unsolved&sortBy=submissions">Median of BST</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a Binary Search Tree of size N, find the Median of its Node values.</span></p>
