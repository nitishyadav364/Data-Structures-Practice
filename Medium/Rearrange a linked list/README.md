<h2><a href="https://www.geeksforgeeks.org/problems/rearrange-a-linked-list/1?page=6&company=Amazon,Microsoft,Flipkart&difficulty=Easy,Medium,Hard&status=unsolved&sortBy=submissions">Rearrange a linked list</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a singly linked list, the task is to rearrange it in a way that all odd position nodes are together and all even positions node are together.<br>
