<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-numbers-or-number1219/1?page=2&company=Amazon,Microsoft,Flipkart,Adobe,Google,Samsung&difficulty=Easy,Medium,Hard&status=unsolved&sortBy=submissions">Sum of two large numbers</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two strings denoting non-negative numbers X and Y. Calculate the sum of X and Y. </span></p>
